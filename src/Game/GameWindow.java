...
public class GameWindow extends JFrame {
    ...
    public static void main(String[] args) throws IOException {
        backGround = ImageIO.read(GameWindow.class.getResourceAsStream("background — space.png"));  // обозначение адреса картинки
        drop = ImageIO.read(GameWindow.class.getResourceAsStream("star.png"));
